...
**Bài toán**
Phát hiện bệnh trên lá lúa bằng kỹ thuật xử lý ảnh và học sâu. 
...
Độ chính xác của mô hình là 80-90%.
Tỷ lệ dữ liệu huấn luyện và kiểm thử là 8:2, điều này có thể dẫn đến hiện tượng quá khớp (overfitting) của mô hình.
Tuy nhiên, trong quá trình thử nghiệm bộ dữ liệu, tôi đã cung cấp bộ dữ liệu của riêng mình.
